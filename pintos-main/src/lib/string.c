...
/*
 * Finds the first differing characters in strings A and B. Returns a
 * positive value if the character in A (as an unsigned char) is greater, a
 * negative value if the character in B (as an unsigned char) is greater, or
 * zero if strings A and B are equal. */
int
